...
public class PlanetTest {
	...
	public void testPlanetGet() {
		...
		HttpGet method = new HttpGet("http://localhost:8080/ex06_2/planet");
		...
		try {
			...
			System.out.println("GET application/xml http://localhost:8080/ex06_2/planet");
	...
	public void testPlanetPost() {
		...
		try {
			...
			System.out.println("POST application/xml http://localhost:8080/ex06_2/planet");
			System.out.println(EntityUtils.toString(response.getEntity(), "UTF-8"));
		} catch (Exception e) {
			e.printStackTrace();
			fail();
